...
class Cart extends Model {
	...
	const SESSION = "Cart"; // constante onde vai armazenar os itens do carrinho, enquanto a sessão estiver aberta.
    ...
    public function setToSession()
    {
        ...
        $_SESSEON[Cart::SESSION] = $this->getValues();
    ...
    public function addProduct(Product $product)
    {
        ...
        $this->getCalculateTotal(); //atualiza o cálculo do frete, quando adiciona mais um produto.
    ...
    public function getProducts() //Lista todos os produtos no carrinho.
    {
        $sql = new Sql();
