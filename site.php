...
$app->get("/categories/:idcategory", function ($idcategory){
    ...
    $page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1; // "?"-> se não for... ":"-> se não...
...
$app->get("/cart/:idproduct/add", function ($idproduct){
    ...
    $cart = Cart::getFromSession(); //recupera o carrinho da sessão
...
$app->post("/register", function(){
    ...
    header('Locattion: /checkout');
    exit;
});

$app->get("/forgot", function(){ //Abre a tela de redefinir a senha
...
$app->post("/forgot/reset", function(){
    ...
    $app->post("/profile/change-password", function(){
        ...
        if($_POST['current_pass'] === $_POST['new_pass']){
            ...
            User::setError("Sua nova senha deve ser diferente.");
